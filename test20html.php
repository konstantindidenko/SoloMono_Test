...
<head>
	...
	<style type="text/css">
		...
		.dropdown.open .caret.caret-right {
		...
		.cabinet-dropdown-panel {
			...
			border: 1px solid #e4e6f2;
			border-radius: 4px;
			box-shadow: 0 10px 30px rgba(43, 45, 56, 0.1);
			cursor: default;
		...
		.cabinet-wrapper:hover .cabinet-dropdown-panel {
			visibility: visible;
			opacity: 1;
		...
		.form-tabs .tab.active {
			color: #3b9ae6;
			font-weight: 600;
			border-bottom: 1px dashed #3b9ae6;
			padding-bottom: 2px;
		}

		.form-tabs .tab:not(.active) {
			color: #3b9ae6;
		}

		.form-tabs .tab:not(.active):hover {
			color: #7fb3d5;
		}
	</style>
</head>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li class="cabinet-wrapper">
					<a href="#">Кабінет</a>
					<div class="cabinet-dropdown-panel">
						<div class="form-tabs" role="tablist">
							<button type="button" class="tab active" role="tab" aria-selected="true">First Name</button>
							<button type="button" class="tab" role="tab" aria-selected="false">Settings</button>
						</div>
						<form class="form-horizontal custom-form">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="label">Label</label>
								<div class="col-sm-8">
									<input type="text" id="label" class="form-control custom-input" value="First Name">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label" for="placeholder">Placeholder</label>
								<div class="col-sm-8">
									<input type="text" id="placeholder" class="form-control custom-input">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="custom-checkbox-wrapper">
										<input type="checkbox" id="req-checkbox">
										<label for="req-checkbox" class="custom-checkbox-label"></label>
									</div>
								</div>
							</div>
						</form>
					...
					<ul class="dropdown-menu">
						<?php foreach ($categories as $category): ?>
							...
							<li class="has-submenu">
								<a href="#" title="<?php echo $category; ?>">
									<?php echo $category; ?>
								...
								<ul class="submenu">
									<?php foreach ($sub_categories as $sub_category): ?>
										<li>
											<a href="#" title="<?php echo $sub_category; ?>">
							...
							<?php else: ?>
								<li><a href="#" title="<?php echo $category; ?>"><?php echo $category; ?></a></li>
							<?php endif; ?>
						<?php endforeach; ?>
					</ul>
				</li>
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-4">
			<h3>Завдання 2</h3>
			<ul>
				<li>При наведенні на категорію "Комп`ютери", показувати список підкатегорій (без JS, використати масив
					PHP <b>$sub_categories</b>)
				</li>
